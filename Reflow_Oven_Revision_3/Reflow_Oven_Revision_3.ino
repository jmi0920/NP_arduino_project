...
void preheat()
{
    for (int i=0;i<7;) // delays for 120 seconds for preheat time (**edit after finding the time it takes to reach 145 C**)
    {
...
void peak()
{
  ...
  for (int i=0;i<7;) //Ramp-to-Peak stage, set to 45 seconds (**edit after finding the time it takes to reach 217 C**)
  {
